...
const ReviewComponent = () => {
  ...
  const fetchReview = async () => {
    setLoading(true);
    try {
      var res = await API.get(`/api/review/${id.id}`, {
  ...
  useEffect(() => {
    if (Object.keys(review).length !== 0)
      if (review.question.length !== 0) {
        {
          setQuestion({
            Q1: review.question[0].Q1,
            Q2: review.question[0].Q2,
            Q3: review.question[0].Q3,
            Q4: review.question[0].Q4,
            Q5: review.question[0].Q5,
            Q6: review.question[0].Q6,
            Q7: review.question[0].Q7,
            Q8: review.question[0].Q8,
            comment: review.comment,
            status: review.status,
            problem_name: review.problem.name,
            description: review.problem.description,
            author: review.problem_by.name,
            tag_one: review.problem.tag_one,
            tag_two: review.problem.tag_two,
          });
        }
      }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      err.response.data.msg && toast.error("Error !", { theme: "colored" });
    }
  };
        ...
        <>
          ...
          <div className="problem-body mb-5">
            ...
            <div className="problem-description">
              ...
              <div
                className="tech_box card_icon"
                style={{ justifyContent: "flex-start" }}
              >
                <div
                  className="tech_stack"
                  style={{ backgroundColor: tech[question.tag_one] }}
                >
                  {question.tag_one}
                </div>
                <div
                  className="tech_stack"
                  style={{ backgroundColor: cat[question.tag_two] }}
                >
                  {question.tag_two}
                </div>
              </div>
                  ...
                  <form className="form">
                    <div className="form-group row p-2">
                      <label className="col-lg-9 col-form-label form-control-label">
                        <b>
                          Please mention the strong points about the problem.
                        </b>
                      </label>
                    ...
                    <div className="form-group row p-2">
                      <label className="col-lg-9 col-form-label form-control-label">
                        <b>
                          {" "}
                          Does the problem match the broad domain of TIH-IITP
                          (speech-vision-text).
                        </b>
                      </label>
                    ...
                    <div className="form-group row p-2">
                      <label className="col-lg-9 col-form-label form-control-label">
                        <b>
                          Does the problem have any potential to make a product
                          or can it lead to a startup?
                        </b>
                      </label>
                    ...
                    <div className="form-group row p-2">
                      <label className="col-lg-9 col-form-label form-control-label">
                        <b>
                          Does the proposal have research challenges in
                    ...
                    <div className="form-group row p-2">
                      <label className="col-lg-9 col-form-label form-control-label">
                        <b>
                          {" "}
                          Please rate the problem in terms of novelty on a scale
                          of 1-5.
                        </b>
                      </label>
                      <div className="col-sm-3">
                    ...
                    <div className="form-group row p-2">
                      <label className="col-lg-9 col-form-label form-control-label">
                        <b>
                          Please rate the problem in terms of relevance in the
                          present context on a scale of 1-5.
                        </b>
                      </label>
                      <div className="col-sm-3">
                        <input
                    ...
                    <div className="form-group row p-2">
                      <div class="col-lg-9">
                        <button
                          ...
                          style={{ backgroundColor: "#0d9460", width: "200px" }}
