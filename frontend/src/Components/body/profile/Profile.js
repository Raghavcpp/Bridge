                ...
                <div className="col-left">
                    {loading ?
                        ...
                        <>
                            ...
                            <button className="btn btn-success" style={{ backgroundColor: '#0d9460', color: 'white', fontSize: '16px', padding: '6px 40px', borderRadius: '5px', margin: '10px 0px', cursor: 'pointer' }} disabled={loading} onClick={handleUpdate}>Update</button></>
                    }
                </div>
